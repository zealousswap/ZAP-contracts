# ZAP Skill — Full Auction Lifecycle

Complete agent skill for the IGRA ZAP Continuous Clearing Auction (CCA): bid → track → exit → claim.
...
| Contract | Address |
|---|---|
| Query (lens) | `0xf40178040278E16c8813dB20a84119A605812FB3` |
| AuctionStateLens | `0xfa458995688c73fc48E7D833483a7206Bed75C27` |
